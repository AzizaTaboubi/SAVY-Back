      ...
      /*  // Wait for the required DOM to be rendered
        ...
        async function scrapeCurrentPage(){
            ...
            let pagePromise = (link) => new Promise(async(resolve, reject) => {
                ...
                //still dont know how to manage this part 
                ...
                dataObj['prix'] = await newPage.$eval('#product_price', div => div.nextSibling.nextSibling.textContent);
